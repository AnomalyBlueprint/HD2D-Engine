...
// Simple 8x8 Bitmap Font (Code Page 437 subset)
// Each byte represents a row of pixels.
constexpr uint8_t BITMAP_FONT[128][8] = {
    ...
    {0x3C, 0x66, 0x6E, 0x6E, 0x60, 0x60, 0x3E, 0x00}, // 64 @
    ...
    {0x00, 0x00, 0x3B, 0x66, 0x66, 0x3E, 0x06, 0x7C}, // 103 g
    ...
    {0x00, 0x00, 0x3B, 0x66, 0x66, 0x66, 0x3E, 0x06}, // 113 q
    ...
    {0x38, 0x6C, 0x38, 0x00, 0x00, 0x00, 0x00, 0x00}, // 126 ~ (Water)
    {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}  // 127 (Full Block)
};
